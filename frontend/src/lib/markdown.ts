...
const ALERT_CONFIGS: Record<
  string,
  { title: string; borderClass: string; textClass: string; bgClass: string; iconSvg: string }
> = {
  NOTE: {
    title: "Note",
    ...
    iconSvg: `<svg class="w-4 h-4 shrink-0 text-accent" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`,
  },
  TIP: {
    title: "Tip",
    ...
    iconSvg: `<svg class="w-4 h-4 shrink-0 text-success" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>`,
  },
  IMPORTANT: {
    title: "Important",
    borderClass: "border-accent",
    ...
    iconSvg: `<svg class="w-4 h-4 shrink-0 text-accent" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>`,
  },
  WARNING: {
    title: "Warning",
    ...
    iconSvg: `<svg class="w-4 h-4 shrink-0 text-warning" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/></svg>`,
  },
  CAUTION: {
    title: "Caution",
  ...
  <div class="overflow-x-auto rounded-b-md bg-bg-elevated" style="padding-top:34px;">
    ...
    blockquote(this: any, { tokens }: { tokens: any[] }) {
      ...
      if (match) {
        ...
        return `<div class="my-3 rounded-r-md border-l-3 ${config.borderClass} ${config.bgClass} p-4 shadow-xs">
  <div class="flex items-center gap-2 font-semibold text-xs mb-1.5 ${config.textClass} uppercase tracking-wide select-none">
    ${config.iconSvg}
